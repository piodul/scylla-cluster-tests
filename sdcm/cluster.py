...
class BaseMonitorSet(object):
    ...
    def __init__(self, targets, params):
        ...
        self.monitor_install_path = os.path.join(self.monitor_install_path_base, "scylla-monitoring-branch-1.0")
    ...
    def download_scylla_monitoring(self, node):
        install_script = dedent("""
            ...
            wget https://github.com/scylladb/scylla-monitoring/archive/branch-1.0.zip
